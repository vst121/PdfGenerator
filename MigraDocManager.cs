...
public static class MigraDocManager
{
    public static Document document;
    public static string FillerText_Text = "AIRboard";
    ...
    public static void DefineCover(Document document)
    {
        ...
        var imgaeFile = General.ProjectPath + "Images//air-logo.png";
        Image image = section.AddImage(imgaeFile);
        image.Width = "10cm";

        paragraph = section.AddParagraph("AIRboard sample document that demonstrates the\ncapabilities of MigraDoc");
    ...
    static void DefineContentSection(Document document)
    {
        ...
        header.AddParagraph("\tAIRboard Documentation");
    ...
    static void DemonstrateIndent(Document document)
    {
        ...
        paragraph.AddText(FillerText_Text);
    ...
    static void DemonstrateFormattedText(Document document)
    {
        ...
        paragraph.AddText("the ");
        formattedText = paragraph.AddFormattedText("font", new Font("Arial"));
        paragraph.AddText(".");
        paragraph.AddLineBreak();
        paragraph.AddText("You can set the ");
    ...
    public static void DemonstrateSimpleTable(Document document)
    {
        ...
        cell.AddParagraph("1");
        cell = row.Cells[1];
        cell.AddParagraph(FillerText_Text);
    ...
    public static void DefineLastPage(Document document)
    {
        Paragraph paragraph = document.LastSection.AddParagraph();
        paragraph.Format.SpaceAfter = "10cm";

        var imgaeFile = General.ProjectPath + "Images//gespraech.jpg";
        Image image = document.LastSection.AddImage(imgaeFile);
        image.Width = "16cm";

        paragraph = document.LastSection.AddParagraph("Thank you for your patience!\nAIRboard Team");
        paragraph.Format.Font.Size = 16;
